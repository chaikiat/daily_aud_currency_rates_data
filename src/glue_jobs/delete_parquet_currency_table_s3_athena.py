...
BUCKET_TO_DEL = 'free-currency-aud-data-parquet-bucket-ck'
DATABASE_TO_DEL = 'de_proj_database'
TABLE_TO_DEL = 'free_currency_aud_data_parquet_tbl'
QUERY_OUTPUT_BUCKET = 's3://query-results-location-de-proj-currency'
