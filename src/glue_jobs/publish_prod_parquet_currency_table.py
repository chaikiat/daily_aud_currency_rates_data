...
QUERY_RESULTS_BUCKET = 's3://query-results-location-de-proj-currency/'
MY_DATABASE = 'de_proj_database'
SOURCE_PARQUET_TABLE_NAME = 'free_currency_aud_data_parquet_tbl'
NEW_PROD_PARQUET_TABLE_NAME = 'free_currency_aud_data_parquet_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-currency-table-prod-ck'
